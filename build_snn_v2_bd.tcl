...
set wd [pwd]
create_project snn_v2_prj $wd/snn_v2_prj -part $part -force
set_property ip_repo_paths [list $wd/ip_iris_snn_v2/hls/impl/ip] [current_project]
update_ip_catalog
...
add_files -norecurse [glob $wd/snn_v2_prj/snn_v2_prj.gen/sources_1/bd/snn_bd/hdl/snn_bd_wrapper.v]
...
# --- collect outputs ---
file copy -force [glob $wd/snn_v2_prj/snn_v2_prj.runs/impl_1/snn_bd_wrapper.bit] $wd/snn_v2.bit
file copy -force [glob $wd/snn_v2_prj/snn_v2_prj.gen/sources_1/bd/snn_bd/hw_handoff/*.hwh] $wd/snn_v2.hwh
puts "BD_BUILD_DONE bit=[file exists $wd/snn_v2.bit] hwh=[file exists $wd/snn_v2.hwh]"
# timing summary
open_run impl_1
